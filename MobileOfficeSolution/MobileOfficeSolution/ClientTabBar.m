...
#import "ClientTabBarButton.h"
#import <QuartzCore/QuartzCore.h>

#define DEFAULT_ITEM_HEIGHT 80.0


@implementation ClientTabBar
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ClientTabBarButton *cell = [tableView dequeueReusableCellWithIdentifier:vtbci];
    if (cell == nil)
    {
        cell = [[ClientTabBarButton alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:vtbci];
    }
